...
?>
<br><br>
<div class="row cspace2 slideanim" style="margin-top: 35px">
<div class="col-sm-7">
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-6">
      ...
      <h4 style="font-weight: bold; text-transform: uppercase;">Compiler</h4>
      <p>Our Portal Supports C/C++ And Java Compilers</p>
      </a>
    </div>
    <div class="col-sm-6">
       <a href="archive.php"><span class="fa fa-archive logo-small"></span>
      <h4 style="font-weight: bold; text-transform: uppercase;">Practice</h4>
      <p>Our Portal Provides Practice Problems Of CSE Labs</p>
      </a>
    </div>
    </div>
    <br><br><br><br>
  <div class="row slideanim">
    ...
    <div class="col-sm-6">
      ...
      <h4 style="font-weight: bold; text-transform: uppercase;">Admin Portal</h4>
