...
<div class="row log">
<div class="col-sm-10">
<div class=""><h3 style="text-align:center;">Problems</h3></div>
</div>
  ...
  while($row=mysqli_fetch_array($sq3))
    {
      ...
      $m=intval($min%60);
        ...
        {
             echo("<div style=\"border:1px solid gray;padding:10px;border-radius:5px;\">Lab Name: <a href=\"contestproblem.php?name=$row[cname]\">$row[cname]</a><br><br>Lab  Date: $row[date_on] <br><br>Start Time: $row[start_at]<br><br>End Time: $row[end_at] <br><br> Status: <b>Running</b> <br><br><!--Time Remaining:  $h hour $mt miniute $scnd second-->
