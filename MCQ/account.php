...
<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b> </span>
...
// while($q99=mysqli_fetch_array($result))
//   $time = $q99['time'];

// date_default_timezone_set("Asia/Kolkata");

// echo date("Y/m/d H:i:s", strtotime("now")) . "\n";
// $tt = date("Y/m/d H:i:s", strtotime("+".$time." minutes"));
...
$q=mysqli_query($con,"SELECT * FROM rank  ORDER BY score DESC " )or die('Error223');
echo  '<div class="panel title"  style="display:none;">
<table class="table table-striped title1" id="datatable" style="display:none;"><thead>
<tr style="color:red"><th><b>Name</b></th><th><b>Score</b></th></tr></thead><tbody>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
<div class="col-md-2 box" style="margin-left: 42%">
